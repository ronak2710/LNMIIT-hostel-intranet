...
<div class="container" style="min-height:395px;width:95%;margin-top:-15px;">
 ...
 <b>
 <ul type="none">
 	<center><li><a href="sample.pdf" target="__self">Rules</a></li><br>
 	<li><a href="sample.pdf" target="_self">Grievance application</a></li><br>
 	<li><a href="sample.pdf" target="_self">Code Of Conduct</a></li><br>
 	<li><a href="sample.pdf" target="_self">Student Information</a></li><br>
	<li><a href="sample.pdf" target="_self">Room Allotment Application</a></li><br>
 	<li><a href="sample.pdf" target="_self">Leave Application</a></li><br></center>
 </ul>
